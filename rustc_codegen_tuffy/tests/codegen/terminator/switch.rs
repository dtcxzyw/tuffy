...
// CHECK:   bb1(v8: mem):
// CHECK:     v9 = iconst 30
// CHECK:     v10 = store.4 v9, v2, v8
// CHECK:     br bb4(v10)
// CHECK:
// CHECK:   bb2(v12: mem):
// CHECK:     v13 = iconst 20
// CHECK:     v14 = store.4 v13, v2, v12
// CHECK:     br bb4(v14)
// CHECK:
// CHECK:   bb3(v16: mem):
// CHECK:     v17 = iconst 10
// CHECK:     v18 = store.4 v17, v2, v16
// CHECK:     br bb4(v18)
// CHECK:
// CHECK:   bb4(v20: mem):
// CHECK:     v21 = load.4 v2, v20
// CHECK:     ret v21, v20
// CHECK:
// CHECK:   bb5(v23: mem):
// CHECK:     v24 = iconst 1
// CHECK:     v25 = icmp.eq v4, v24
